                ...
                <div className="service-details-wrapper">
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <Image src="/assets/img/service/details-1.jpg" alt="img" width={1386} height={664}   />
                            </div>
                        </div>
                    </div>
                    <div className="row g-5">
                            ...
                            <div className="main-sidebar sticky-style">
                                <div className="single-sidebar-widget">
                                    ...
                                    <div className="service-widget-categories">
                                        <ul>
                                            <li><Link href="/service/service-details">Web Development</Link> <span><i className="bi bi-arrow-right"></i></span></li>
                                            <li><Link href="/service/service-details">Content Marketing</Link> <span><i className="bi bi-arrow-right"></i></span></li>
                                            <li className="active"><Link href="/service/service-details">Social Media Mesketing</Link><span><i className="bi bi-arrow-right"></i></span></li>
                                            <li><Link href="/service/service-details">Affiliate Marketing</Link> <span><i className="bi bi-arrow-right"></i></span></li>
                                            <li><Link href="/service/service-details">Search Engine Marketing (SEM)</Link> <span><i className="bi bi-arrow-right"></i></span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-12 col-lg-8">
                            <div className="service-details-content">
                                ...
                                <div className="thumb">
                                <Image src="/assets/img/service/details-2.jpg" alt="img" width={908} height={456}   />
                                </div>
                                <h3>
                                    The Challange
                                </h3>
