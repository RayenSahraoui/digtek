...
const WhatWeDo = () => {
    ...
    return (
        <section className="service-section fix section-padding">
            ...
            <Image src="/assets/img/service/left-shape.png" alt="img" width={180} height={294}   />
            </div>
            <div className="right-shape">
            <Image src="/assets/img/service/right-shape.png" alt="img" width={94} height={94}   />
            </div>
            <div className="bg-shape">
            <Image src="/assets/img/service/bg-shape.png" alt="img" width={560} height={931}   />
            </div>
                    ...
                    <div key={i} className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div className="service-box-items">
                            ...
                            <div className="content"> 
                                ...
                                <p>{item.content}</p>
                                <Link href="/service/service-details" className="link-btn">Read More <i className="bi bi-arrow-right"></i></Link>
                            </div>
                        </div>
                    </div>
                    ))}
