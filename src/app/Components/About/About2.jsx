                ...
                <div className="about-wrapper-2">
                    <div className="row g-4">
                        <div className="col-lg-6">
                            ...
                            <Image src={aboutContent.img} alt="img" className="wow img-custom-anim-left" width={537} height={608}   />
                                <div className="box-shape float-bob-y">
                                <Image src="/assets/img/about/box-shape-2.png" alt="img" width={341} height={171}   />
                                </div>
                                <div className="gap-shape float-bob-x">
                                <Image src="/assets/img/about/grap-2.png" alt="img" width={391} height={365}   />
                                </div>
                            ...
                            <div className="about-content">
                                ...
                                <div className="about-button">
                                    <div className="main-button wow fadeInUp" data-wow-delay=".3s">
                                        <Link href="/about"> <span className="theme-btn">ABOUT US MORE </span><span className="arrow-btn"><i className="bi bi-arrow-up-right"></i></span></Link>
                                    </div>
