...
const About1 = () => {
    ...
    return (
        ...
        <div className="left-shape float-bob-y">
           <Image src="/assets/img/about/left-shape.png" alt="img" width={277} height={783}   />
        </div>
                ...
                <div className="row g-4">
                    <div className="col-lg-6">
                        <div className="about-image">
                            <Image src={aboutContent.img} alt="img" className="wow img-custom-anim-left" width={362} height={539}   />
                            <div className="bg-shape">
                            <Image src="/assets/img/about/bg-shape.png" alt="img" width={465} height={350}   />
                            </div>
                            <div className="grap-shape float-bob-x">
                            <Image src="/assets/img/about/grap.png" alt="img" width={216} height={145}   />
                            </div>
                            <div className="box-shape float-bob-y">
                            <Image src="/assets/img/about/box-shape.png" alt="img" width={254} height={145}   />
                            </div>
                            <div className="emoji-shape">
                            <Image src="/assets/img/about/emoji.png" alt="img" width={82} height={82}   />
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6">
