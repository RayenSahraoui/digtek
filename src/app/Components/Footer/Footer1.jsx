...
const Footer1 = () => {
    ...
    return (
        <div>
            ...
            <Image src="/assets/img/rokect.png" alt="Logo" width={169} height={191}   />
            </div>
            <div className="container">
                <div className="cta-wrapper bg-cover" data-background="/assets/img/cta-bg.jpg">
                    ...
                    <Image src="/assets/img/cta-img.png" alt="Logo" width={321} height={291}   />
                    </div>
                    <h2 className="wow fadeInUp" data-wow-delay=".3s">
                        Stay Connected With <br/> Cutting Edge IT
                    </h2>
                    <div className="main-button wow fadeInUp" data-wow-delay=".5s">
                        <Link href="/contact"> <span className="theme-btn"> talk TO  A SPECIALIST </span><span className="arrow-btn"> <i className="bi bi-arrow-right"></i></span></Link>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div className="single-footer-widget">
                                <div className="widget-head">
                                    <a href="#">
                                    <Image src="/assets/img/logo/white-logo.svg" alt="Logo" width={171} height={44}   />
                                    </a>
                                </div>
